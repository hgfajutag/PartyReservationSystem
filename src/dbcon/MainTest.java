...
public class MainTest {
	...
	public static void main(String[] args) throws SQLException {
		...
		ResultSet rs=stmt.executeQuery("select a.id, a.code, a.name, ad.id, ad.street, ad.city, ad.state, ad.zip FROM airport a INNER JOIN address ad ON a.addressid=ad.id ");  
		while(rs.next())  
